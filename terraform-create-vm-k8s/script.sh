...
terraform apply -auto-approve -var "GOVC_URL=vcenter.idevops.io.vn" -var "GOVC_USERNAME=administrator@vsphere.local" -var "GOVC_PASSWORD=123abc@A" -parallelism=2
